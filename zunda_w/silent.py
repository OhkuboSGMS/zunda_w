...
def _divide_by_silence(
    segment: AudioSegment,
    min_silence_len=4000,
    seek_step=10,
    silence_thresh_down=-20,
    min_length=500,
) -> List[Tuple[int, AudioSegment, Segment]]:
    dbFS = segment.dBFS
    result = silence.detect_nonsilent(
        segment,
