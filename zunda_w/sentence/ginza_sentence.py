...
class GinzaSentence:
    ...
    def reconstruct(self, srt_file: str, output: Optional[str] = None, encoding='utf-8') -> str:
        return _reconstruct(srt_file, self.n_divide_char, self.min_char, output, encoding)


def _reconstruct(srt_file: str, n_divide_char=12, min_char: int = 10, output: Optional[str] = None,
                 encoding='utf-8') -> str:
    """
